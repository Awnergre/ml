...
<head>
    ...
    <style>
        ...
        /* CATEGORY BAR: horizontal scroll & no background */
        .category-bar {
            display: flex;
            gap: 10px;
            margin: 0 0 28px 0;
            flex-wrap: nowrap;              /* Supaya kategori tetap ke samping */
            overflow-x: auto;               /* Scroll horizontal jika kelebihan */
            -webkit-overflow-scrolling: touch;
            scrollbar-width: thin;
            scrollbar-color: #b7dbfa #fff;
            padding-bottom: 6px;
        }
        ...
        .category-btn.active,
        .category-btn:hover {
            background: var(--category-active-bg) !important;
            color: var(--category-active-color) !important;
        ...
        @media (max-width: 900px) {
            .container { max-width: 100vw; padding: 18px 1vw 18px; }
            .brand-header { flex-wrap: wrap; gap: 10px; }
            .game-list { grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 18px 8px; }
        }
        @media (max-width: 700px) {
            .container {padding: 10px 0 10px;}
            .brand-header { flex-direction: row; align-items: center; gap: 7px 0; }
            .brand-actions { flex-direction: row; align-items: center; gap: 7px 0; margin-left: auto; width: auto; }
            .search-box { margin-left: 0; min-width: 120px; width: 100%; max-width: 100%; }
        ...
        @media (max-width: 520px) {
            .container { border-radius: 0; margin: 0; padding: 2vw 0 2vw; min-width: 100vw; max-width: 100vw; }
...
<body>
    <div class="container">
        ...
        <div class="category-bar" id="categoryBar">
            ...
            <!-- Tambahkan kategori lain jika perlu, akan tetap horizontal dan di-scroll kalau penuh -->
        </div>
        <!-- Banner Slider -->
